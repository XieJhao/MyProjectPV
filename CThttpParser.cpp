...
CHttpParser::CHttpParser()
{
	...
	m_settings.on_header_field = &CHttpParser::OnHeadersField;
	m_settings.on_header_value = &CHttpParser::OnHeadersValue;
...
int CHttpParser::OnHeadersField(http_parser* parser, const char* at, size_t length)
{
	return ((CHttpParser*)parser->data)->OnHeadersField(at,length);
}

int CHttpParser::OnHeadersValue(http_parser* parser, const char* at, size_t length)
{
	return ((CHttpParser*)parser->data)->OnHeadersValue(at,length);
}
...
int CHttpParser::OnHeadersField(const char* at, size_t length)
{
	m_lastField = Buffer(at, length);
	return 0;
}

int CHttpParser::OnHeadersValue(const char* at, size_t length)
{
	m_HreaderValues[m_lastField] = Buffer(at, length);
	return 0;
}
